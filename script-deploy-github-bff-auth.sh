#!/bin/bash
# =============================================================================
# 🚀 MINI MANUAL DE USO — script-deploy-github-bff-auth.sh (bff-auth)
# =============================================================================
...
#      $ ./script-deploy-github-bff-auth.sh
#      -> Envia para a branch ativa (ex: develop) e gera as tags:
#         ghcr.io/keepguard/bff-auth:develop-<sha>
#         ghcr.io/keepguard/bff-auth:develop-latest
#
#   2. Commit, push, build e deploy imediato no Docker Compose local:
#      $ ./script-deploy-github-bff-auth.sh up
...
#      $ ./script-deploy-github-bff-auth.sh merge main
...
#      $ ./script-deploy-github-bff-auth.sh merge main up
#
#   5. Pipeline Completo em 1 comando (Merge 'main' + Docker Local + K8s Produção):
#      $ ./script-deploy-github-bff-auth.sh merge main up prod
#      OU simplesmente:
#      $ ./script-deploy-github-bff-auth.sh full
