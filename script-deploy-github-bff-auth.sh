...
# Build, Push (Commit SHA + latest) e Deploy Local do BFF Auth
#
# Uso:
#   ./script-deploy-github-bff-auth.sh up       # Commit, Push GHCR + Sobe no Docker Local
#   ./script-deploy-github-bff-auth.sh          # Commit, Push GHCR (sem subir local)
# =============================================================================
